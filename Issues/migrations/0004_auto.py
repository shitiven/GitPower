...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field ignores on 'Issue'
        db.create_table('Issues_issue_ignores', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm['Issues.issue'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('Issues_issue_ignores', ['issue_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field ignores on 'Issue'
        db.delete_table('Issues_issue_ignores')


    models = {
        'Depot.repo': {
            'Meta': {'unique_together': "(('name', 'owner'),)", 'object_name': 'Repo'},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
        ...
        'Issues.comment': {
            ...
            'comment_type': ('django.db.models.fields.CharField', [], {'default': "'CFI'", 'max_length': '4'}),
        ...
        'Issues.issue': {
            ...
            'commented': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
            'content': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ignores': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'issue_ignores'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            ...
            'subscribers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'issue_subscribers'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'})
        },
        'Issues.issuelabel': {
