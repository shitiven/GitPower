...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.comment_type'
        db.add_column('Issues_comment', 'comment_type',
                      self.gf('django.db.models.fields.CharField')(default='CFI', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.comment_type'
        db.delete_column('Issues_comment', 'comment_type')
    ...
    models = {
        ...
        'Issues.comment': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'Issues.issue': {
            ...
            'commented': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)'}),
            'content': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)'})
        },
        'Issues.issuelabel': {
