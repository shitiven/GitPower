...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('NewsFeed_newsfeed', (
            ...
            ('news_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 23, 0, 0))),
            ('pull', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Pull.PullRequest'], null=True)),
            ('repo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Depot.Repo'], null=True)),
            ('actioner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ))
    ...
    models = {
        ...
        'NewsFeed.newsfeed': {
            ...
            'actioner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'content': ('django.db.models.fields.TextField', [], {}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'news_type': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'pull': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Pull.PullRequest']", 'null': 'True'}),
            'repo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Depot.Repo']", 'null': 'True'})
        },
        'Pull.pullrequest': {
